...
const teamCatalog = {
  ...
  EGY: { name: "Egypt", group: "Group G", points: 5, record: { w: 1, d: 2, l: 0 }, nextMatch: "Jul 3, 2:00 PM ET vs Australia" },
  IRN: { name: "Iran", group: "Group G", points: 3, record: { w: 0, d: 3, l: 0 }, nextMatch: "Eliminated" },
  NZL: { name: "New Zealand", group: "Group G", points: 1, record: { w: 0, d: 1, l: 2 }, nextMatch: "Eliminated" },

  ESP: { name: "Spain", group: "Group H", points: 7, record: { w: 2, d: 1, l: 0 }, nextMatch: "Jul 2, 3:00 PM ET vs Austria" },
  CPV: { name: "Cape Verde", group: "Group H", points: 3, record: { w: 0, d: 3, l: 0 }, nextMatch: "Jul 3, 6:00 PM ET vs Argentina" },
  ...
  ARG: { name: "Argentina", group: "Group J", points: 9, record: { w: 3, d: 0, l: 0 }, nextMatch: "Jul 3, 6:00 PM ET vs Cape Verde" },
  AUT: { name: "Austria", group: "Group J", points: 4, record: { w: 1, d: 1, l: 1 }, nextMatch: "Jul 2, 3:00 PM ET vs Spain" },
  ALG: { name: "Algeria", group: "Group J", points: 4, record: { w: 1, d: 1, l: 1 }, nextMatch: "Jul 2, 11:00 PM ET vs Switzerland" },
  JOR: { name: "Jordan", group: "Group J", points: 0, record: { w: 0, d: 0, l: 3 }, nextMatch: "Eliminated" },

  COL: { name: "Colombia", group: "Group K", points: 7, record: { w: 2, d: 1, l: 0 }, nextMatch: "Jul 3, 9:30 PM ET vs Ghana" },
  POR: { name: "Portugal", group: "Group K", points: 5, record: { w: 1, d: 2, l: 0 }, nextMatch: "Jul 2, 7:00 PM ET vs Croatia" },
  COD: { name: "DR Congo", group: "Group K", points: 4, record: { w: 1, d: 1, l: 1 }, nextMatch: "Jul 1, 12:00 PM ET vs England" },
  UZB: { name: "Uzbekistan", group: "Group K", points: 0, record: { w: 0, d: 0, l: 3 }, nextMatch: "Eliminated" },

  ENG: { name: "England", group: "Group L", points: 7, record: { w: 2, d: 1, l: 0 }, nextMatch: "Jul 1, 12:00 PM ET vs DR Congo" },
  CRO: { name: "Croatia", group: "Group L", points: 6, record: { w: 2, d: 0, l: 1 }, nextMatch: "Jul 2, 7:00 PM ET vs Portugal" },
...
{ date: "Jun 11", time: "3:00 PM ET", teamCode: "MEX", team: "Mexico", opponent: "South Africa", result: "2-0", status: "Win", pts: 3 },
  ...
  { date: "Jun 17", time: "1:00 PM ET", teamCode: "POR", team: "Portugal", opponent: "DR Congo", result: "1-1", status: "Draw", pts: 1 },
  { date: "Jun 17", time: "1:00 PM ET", teamCode: "COD", team: "DR Congo", opponent: "Portugal", result: "1-1", status: "Draw", pts: 1 },
  { date: "Jun 17", time: "4:00 PM ET", teamCode: "ENG", team: "England", opponent: "Croatia", result: "4-2", status: "Win", pts: 3 },
  { date: "Jun 17", time: "4:00 PM ET", teamCode: "CRO", team: "Croatia", opponent: "England", result: "2-4", status: "Loss", pts: 0 },
  { date: "Jun 17", time: "7:00 PM ET", teamCode: "GHA", team: "Ghana", opponent: "Panama", result: "1-0", status: "Win", pts: 3 },
  { date: "Jun 17", time: "7:00 PM ET", teamCode: "PAN", team: "Panama", opponent: "Ghana", result: "0-1", status: "Loss", pts: 0 },
  { date: "Jun 18", time: "2:00 AM ET", teamCode: "UZB", team: "Uzbekistan", opponent: "Colombia", result: "1-3", status: "Loss", pts: 0 },
  { date: "Jun 18", time: "2:00 AM ET", teamCode: "COL", team: "Colombia", opponent: "Uzbekistan", result: "3-1", status: "Win", pts: 3 },

  { date: "Jun 18", time: "12:00 PM ET", teamCode: "CZE", team: "Czechia", opponent: "South Africa", result: "1-1", status: "Draw", pts: 1 },
  { date: "Jun 18", time: "12:00 PM ET", teamCode: "RSA", team: "South Africa", opponent: "Czechia", result: "1-1", status: "Draw", pts: 1 },
  { date: "Jun 18", time: "3:00 PM ET", teamCode: "SUI", team: "Switzerland", opponent: "Bosnia and Herzegovina", result: "4-1", status: "Win", pts: 3 },
  { date: "Jun 18", time: "3:00 PM ET", teamCode: "BIH", team: "Bosnia and Herzegovina", opponent: "Switzerland", result: "1-4", status: "Loss", pts: 0 },
  { date: "Jun 18", time: "6:00 PM ET", teamCode: "CAN", team: "Canada", opponent: "Qatar", result: "6-0", status: "Win", pts: 3 },
  { date: "Jun 18", time: "6:00 PM ET", teamCode: "QAT", team: "Qatar", opponent: "Canada", result: "0-6", status: "Loss", pts: 0 },
  { date: "Jun 18", time: "9:00 PM ET", teamCode: "MEX", team: "Mexico", opponent: "South Korea", result: "1-0", status: "Win", pts: 3 },
  { date: "Jun 18", time: "9:00 PM ET", teamCode: "KOR", team: "South Korea", opponent: "Mexico", result: "0-1", status: "Loss", pts: 0 },

  { date: "Jun 19", time: "3:00 PM ET", teamCode: "USA", team: "United States", opponent: "Australia", result: "2-0", status: "Win", pts: 3 },
  { date: "Jun 19", time: "3:00 PM ET", teamCode: "AUS", team: "Australia", opponent: "United States", result: "0-2", status: "Loss", pts: 0 },
  { date: "Jun 19", time: "6:00 PM ET", teamCode: "SCO", team: "Scotland", opponent: "Morocco", result: "0-1", status: "Loss", pts: 0 },
  { date: "Jun 19", time: "6:00 PM ET", teamCode: "MAR", team: "Morocco", opponent: "Scotland", result: "1-0", status: "Win", pts: 3 },
  { date: "Jun 19", time: "8:30 PM ET", teamCode: "BRA", team: "Brazil", opponent: "Haiti", result: "3-0", status: "Win", pts: 3 },
  { date: "Jun 19", time: "8:30 PM ET", teamCode: "HAI", team: "Haiti", opponent: "Brazil", result: "0-3", status: "Loss", pts: 0 },
  { date: "Jun 19", time: "11:00 PM ET", teamCode: "TUR", team: "Türkiye", opponent: "Paraguay", result: "0-1", status: "Loss", pts: 0 },
  { date: "Jun 19", time: "11:00 PM ET", teamCode: "PAR", team: "Paraguay", opponent: "Türkiye", result: "1-0", status: "Win", pts: 3 },

  { date: "Jun 20", time: "1:00 PM ET", teamCode: "NED", team: "Netherlands", opponent: "Sweden", result: "5-1", status: "Win", pts: 3 },
  { date: "Jun 20", time: "1:00 PM ET", teamCode: "SWE", team: "Sweden", opponent: "Netherlands", result: "1-5", status: "Loss", pts: 0 },
  { date: "Jun 20", time: "4:00 PM ET", teamCode: "GER", team: "Germany", opponent: "Côte d'Ivoire", result: "2-1", status: "Win", pts: 3 },
  { date: "Jun 20", time: "4:00 PM ET", teamCode: "CIV", team: "Côte d'Ivoire", opponent: "Germany", result: "1-2", status: "Loss", pts: 0 },
  { date: "Jun 20", time: "8:00 PM ET", teamCode: "ECU", team: "Ecuador", opponent: "Curaçao", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 20", time: "8:00 PM ET", teamCode: "CUW", team: "Curaçao", opponent: "Ecuador", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 21", time: "12:00 AM ET", teamCode: "TUN", team: "Tunisia", opponent: "Japan", result: "0-4", status: "Loss", pts: 0 },
  { date: "Jun 21", time: "12:00 AM ET", teamCode: "JPN", team: "Japan", opponent: "Tunisia", result: "4-0", status: "Win", pts: 3 },

  { date: "Jun 21", time: "12:00 PM ET", teamCode: "ESP", team: "Spain", opponent: "Saudi Arabia", result: "4-0", status: "Win", pts: 3 },
  { date: "Jun 21", time: "12:00 PM ET", teamCode: "KSA", team: "Saudi Arabia", opponent: "Spain", result: "0-4", status: "Loss", pts: 0 },
  { date: "Jun 21", time: "3:00 PM ET", teamCode: "BEL", team: "Belgium", opponent: "Iran", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 21", time: "3:00 PM ET", teamCode: "IRN", team: "Iran", opponent: "Belgium", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 21", time: "6:00 PM ET", teamCode: "URU", team: "Uruguay", opponent: "Cape Verde", result: "2-2", status: "Draw", pts: 1 },
  { date: "Jun 21", time: "6:00 PM ET", teamCode: "CPV", team: "Cape Verde", opponent: "Uruguay", result: "2-2", status: "Draw", pts: 1 },
  { date: "Jun 21", time: "9:00 PM ET", teamCode: "NZL", team: "New Zealand", opponent: "Egypt", result: "1-3", status: "Loss", pts: 0 },
  { date: "Jun 21", time: "9:00 PM ET", teamCode: "EGY", team: "Egypt", opponent: "New Zealand", result: "3-1", status: "Win", pts: 3 },

  { date: "Jun 22", time: "1:00 PM ET", teamCode: "ARG", team: "Argentina", opponent: "Austria", result: "2-0", status: "Win", pts: 3 },
  { date: "Jun 22", time: "1:00 PM ET", teamCode: "AUT", team: "Austria", opponent: "Argentina", result: "0-2", status: "Loss", pts: 0 },
  { date: "Jun 22", time: "5:00 PM ET", teamCode: "FRA", team: "France", opponent: "Iraq", result: "3-0", status: "Win", pts: 3 },
  { date: "Jun 22", time: "5:00 PM ET", teamCode: "IRQ", team: "Iraq", opponent: "France", result: "0-3", status: "Loss", pts: 0 },
  { date: "Jun 22", time: "8:00 PM ET", teamCode: "NOR", team: "Norway", opponent: "Senegal", result: "3-2", status: "Win", pts: 3 },
  { date: "Jun 22", time: "8:00 PM ET", teamCode: "SEN", team: "Senegal", opponent: "Norway", result: "2-3", status: "Loss", pts: 0 },
  { date: "Jun 22", time: "11:00 PM ET", teamCode: "JOR", team: "Jordan", opponent: "Algeria", result: "1-2", status: "Loss", pts: 0 },
  { date: "Jun 22", time: "11:00 PM ET", teamCode: "ALG", team: "Algeria", opponent: "Jordan", result: "2-1", status: "Win", pts: 3 },

  { date: "Jun 23", time: "1:00 PM ET", teamCode: "POR", team: "Portugal", opponent: "Uzbekistan", result: "5-0", status: "Win", pts: 3 },
  { date: "Jun 23", time: "1:00 PM ET", teamCode: "UZB", team: "Uzbekistan", opponent: "Portugal", result: "0-5", status: "Loss", pts: 0 },
  { date: "Jun 23", time: "4:00 PM ET", teamCode: "ENG", team: "England", opponent: "Ghana", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 23", time: "4:00 PM ET", teamCode: "GHA", team: "Ghana", opponent: "England", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 23", time: "7:00 PM ET", teamCode: "PAN", team: "Panama", opponent: "Croatia", result: "0-1", status: "Loss", pts: 0 },
  { date: "Jun 23", time: "7:00 PM ET", teamCode: "CRO", team: "Croatia", opponent: "Panama", result: "1-0", status: "Win", pts: 3 },
  { date: "Jun 23", time: "10:00 PM ET", teamCode: "COL", team: "Colombia", opponent: "DR Congo", result: "1-0", status: "Win", pts: 3 },
  { date: "Jun 23", time: "10:00 PM ET", teamCode: "COD", team: "DR Congo", opponent: "Colombia", result: "0-1", status: "Loss", pts: 0 },

  { date: "Jun 24", time: "3:00 PM ET", teamCode: "SUI", team: "Switzerland", opponent: "Canada", result: "2-1", status: "Win", pts: 3 },
  { date: "Jun 24", time: "3:00 PM ET", teamCode: "CAN", team: "Canada", opponent: "Switzerland", result: "1-2", status: "Loss", pts: 0 },
  { date: "Jun 24", time: "3:00 PM ET", teamCode: "BIH", team: "Bosnia and Herzegovina", opponent: "Qatar", result: "3-1", status: "Win", pts: 3 },
  { date: "Jun 24", time: "3:00 PM ET", teamCode: "QAT", team: "Qatar", opponent: "Bosnia and Herzegovina", result: "1-3", status: "Loss", pts: 0 },
  { date: "Jun 24", time: "6:00 PM ET", teamCode: "SCO", team: "Scotland", opponent: "Brazil", result: "0-3", status: "Loss", pts: 0 },
  { date: "Jun 24", time: "6:00 PM ET", teamCode: "BRA", team: "Brazil", opponent: "Scotland", result: "3-0", status: "Win", pts: 3 },
  { date: "Jun 24", time: "6:00 PM ET", teamCode: "MAR", team: "Morocco", opponent: "Haiti", result: "4-2", status: "Win", pts: 3 },
  { date: "Jun 24", time: "6:00 PM ET", teamCode: "HAI", team: "Haiti", opponent: "Morocco", result: "2-4", status: "Loss", pts: 0 },
  { date: "Jun 24", time: "9:00 PM ET", teamCode: "CZE", team: "Czechia", opponent: "Mexico", result: "0-3", status: "Loss", pts: 0 },
  { date: "Jun 24", time: "9:00 PM ET", teamCode: "MEX", team: "Mexico", opponent: "Czechia", result: "3-0", status: "Win", pts: 3 },
  { date: "Jun 24", time: "9:00 PM ET", teamCode: "RSA", team: "South Africa", opponent: "South Korea", result: "1-0", status: "Win", pts: 3 },
  { date: "Jun 24", time: "9:00 PM ET", teamCode: "KOR", team: "South Korea", opponent: "South Africa", result: "0-1", status: "Loss", pts: 0 },

  { date: "Jun 25", time: "4:00 PM ET", teamCode: "CUW", team: "Curaçao", opponent: "Côte d'Ivoire", result: "0-2", status: "Loss", pts: 0 },
  { date: "Jun 25", time: "4:00 PM ET", teamCode: "CIV", team: "Côte d'Ivoire", opponent: "Curaçao", result: "2-0", status: "Win", pts: 3 },
  { date: "Jun 25", time: "4:00 PM ET", teamCode: "ECU", team: "Ecuador", opponent: "Germany", result: "2-1", status: "Win", pts: 3 },
  { date: "Jun 25", time: "4:00 PM ET", teamCode: "GER", team: "Germany", opponent: "Ecuador", result: "1-2", status: "Loss", pts: 0 },
  { date: "Jun 25", time: "7:00 PM ET", teamCode: "JPN", team: "Japan", opponent: "Sweden", result: "1-1", status: "Draw", pts: 1 },
  { date: "Jun 25", time: "7:00 PM ET", teamCode: "SWE", team: "Sweden", opponent: "Japan", result: "1-1", status: "Draw", pts: 1 },
  { date: "Jun 25", time: "7:00 PM ET", teamCode: "TUN", team: "Tunisia", opponent: "Netherlands", result: "1-3", status: "Loss", pts: 0 },
  { date: "Jun 25", time: "7:00 PM ET", teamCode: "NED", team: "Netherlands", opponent: "Tunisia", result: "3-1", status: "Win", pts: 3 },
  { date: "Jun 25", time: "10:00 PM ET", teamCode: "TUR", team: "Türkiye", opponent: "United States", result: "3-2", status: "Win", pts: 3 },
  { date: "Jun 25", time: "10:00 PM ET", teamCode: "USA", team: "United States", opponent: "Türkiye", result: "2-3", status: "Loss", pts: 0 },
  { date: "Jun 25", time: "10:00 PM ET", teamCode: "PAR", team: "Paraguay", opponent: "Australia", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 25", time: "10:00 PM ET", teamCode: "AUS", team: "Australia", opponent: "Paraguay", result: "0-0", status: "Draw", pts: 1 },

  { date: "Jun 26", time: "3:00 PM ET", teamCode: "NOR", team: "Norway", opponent: "France", result: "1-4", status: "Loss", pts: 0 },
  { date: "Jun 26", time: "3:00 PM ET", teamCode: "FRA", team: "France", opponent: "Norway", result: "4-1", status: "Win", pts: 3 },
  { date: "Jun 26", time: "3:00 PM ET", teamCode: "SEN", team: "Senegal", opponent: "Iraq", result: "5-0", status: "Win", pts: 3 },
  { date: "Jun 26", time: "3:00 PM ET", teamCode: "IRQ", team: "Iraq", opponent: "Senegal", result: "0-5", status: "Loss", pts: 0 },
  { date: "Jun 26", time: "8:00 PM ET", teamCode: "CPV", team: "Cape Verde", opponent: "Saudi Arabia", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 26", time: "8:00 PM ET", teamCode: "KSA", team: "Saudi Arabia", opponent: "Cape Verde", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 26", time: "8:00 PM ET", teamCode: "URU", team: "Uruguay", opponent: "Spain", result: "0-1", status: "Loss", pts: 0 },
  { date: "Jun 26", time: "8:00 PM ET", teamCode: "ESP", team: "Spain", opponent: "Uruguay", result: "1-0", status: "Win", pts: 3 },
  { date: "Jun 26", time: "11:00 PM ET", teamCode: "EGY", team: "Egypt", opponent: "Iran", result: "1-1", status: "Draw", pts: 1 },
  { date: "Jun 26", time: "11:00 PM ET", teamCode: "IRN", team: "Iran", opponent: "Egypt", result: "1-1", status: "Draw", pts: 1 },
  { date: "Jun 26", time: "11:00 PM ET", teamCode: "NZL", team: "New Zealand", opponent: "Belgium", result: "1-5", status: "Loss", pts: 0 },
  { date: "Jun 26", time: "11:00 PM ET", teamCode: "BEL", team: "Belgium", opponent: "New Zealand", result: "5-1", status: "Win", pts: 3 },

  { date: "Jun 27", time: "5:00 PM ET", teamCode: "PAN", team: "Panama", opponent: "England", result: "0-2", status: "Loss", pts: 0 },
  { date: "Jun 27", time: "5:00 PM ET", teamCode: "ENG", team: "England", opponent: "Panama", result: "2-0", status: "Win", pts: 3 },
  { date: "Jun 27", time: "5:00 PM ET", teamCode: "CRO", team: "Croatia", opponent: "Ghana", result: "2-1", status: "Win", pts: 3 },
  { date: "Jun 27", time: "5:00 PM ET", teamCode: "GHA", team: "Ghana", opponent: "Croatia", result: "1-2", status: "Loss", pts: 0 },
  { date: "Jun 27", time: "7:30 PM ET", teamCode: "COL", team: "Colombia", opponent: "Portugal", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 27", time: "7:30 PM ET", teamCode: "POR", team: "Portugal", opponent: "Colombia", result: "0-0", status: "Draw", pts: 1 },
  { date: "Jun 27", time: "7:30 PM ET", teamCode: "COD", team: "DR Congo", opponent: "Uzbekistan", result: "3-1", status: "Win", pts: 3 },
  { date: "Jun 27", time: "7:30 PM ET", teamCode: "UZB", team: "Uzbekistan", opponent: "DR Congo", result: "1-3", status: "Loss", pts: 0 },
  { date: "Jun 27", time: "10:00 PM ET", teamCode: "ALG", team: "Algeria", opponent: "Austria", result: "3-3", status: "Draw", pts: 1 },
  { date: "Jun 27", time: "10:00 PM ET", teamCode: "AUT", team: "Austria", opponent: "Algeria", result: "3-3", status: "Draw", pts: 1 },
  { date: "Jun 27", time: "10:00 PM ET", teamCode: "JOR", team: "Jordan", opponent: "Argentina", result: "1-3", status: "Loss", pts: 0 },
